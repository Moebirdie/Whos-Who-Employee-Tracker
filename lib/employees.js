...
class EmployeeClass {
  ...
  async viewAllEmployees() {
    const sql = 'SELECT id, first_name, last_name, role_id, manager_id, is_active FROM employee';
  ...
  async updateManagerId(managerId, id ) {
    const sql = 'UPDATE department SET manager_id = ? WHERE id = ?';
