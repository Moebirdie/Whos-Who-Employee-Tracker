...
class EmployeeClass {
  ...
  async viewAllEmployees() {
    const sql = 'SELECT id, first_name, last_name, role_id, manager_id, is_active FROM employee ORDER BY last_name, first_name';
  ...
  async viewAllEmployeesByManager() {
    const sql = 'SELECT emp.id, emp.first_name, emp.last_name, emp.role_id, emp.is_active, emp.manager_id, man.first_name AS manager_first_name, man.last_name AS manager_last_name FROM employee emp LEFT JOIN employee man ON emp.manager_id = man.id ORDER BY emp.manager_id, emp.last_name, emp.first_name';
    return runTableQuery(sql);
    };
  ...
  async viewEmployeeByManagerId(managerId) {
    const sql = 'SELECT emp.id, emp.first_name, emp.last_name, emp.role_id, emp.manager_id, man.first_name AS manager_first_name, man.last_name AS manager_last_name FROM employee emp LEFT JOIN employee man ON emp.manager_id = man.id WHERE emp.manager_id = ? ORDER BY emp.last_name, emp.first_name';
